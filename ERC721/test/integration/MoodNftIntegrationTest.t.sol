...
contract MoodNftIntegrationTest is Test {
    ...
    /**
         * @dev Tests the functionality of flipping the mood of a token to sad.
         * The test follows these steps:
         * - Pranks the user
         * - Mints a new NFT
         * - Pranks the user again
         * - Flips the mood of the minted NFT
         * - Asserts that the tokenURI of the NFT is equal to the URI of a sad SVG
         * 
         * @notice This is a test function and is only used for testing purposes.
         */
